...
public class ECBCurrentRateProvider extends ECBAbstractRateProvider {
     ...
     */
    private static final ProviderContext CONTEXT = ProviderContextBuilder.of("ECB", RateType.DEFERRED)
            .set("providerDescription", "European Central Bank")
            .set("days", 1).build();

    public ECBCurrentRateProvider() {
        super(CONTEXT, "https://raw.githubusercontent.com/instant-solutions/quarkus-moneta-data/refs/heads/main/ecb-daily.xml");
    }
