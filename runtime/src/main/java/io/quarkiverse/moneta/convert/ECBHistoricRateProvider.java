 ...
 * </p>
 * <p>
 * The default date is yesterday or the most recent day of week. To uses exchange rate from a specific date, you can use this
 * way:
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * <code>ConversionQuery conversionQuery = ConversionQueryBuilder.of().setTermCurrency(euro).set(localDate).build();</code>
 * <p>
...
public class ECBHistoricRateProvider extends ECBAbstractRateProvider {
     ...
     */
    private static final ProviderContext CONTEXT = ProviderContextBuilder.of("ECB-HIST", RateType.HISTORIC, RateType.DEFERRED)
    ...
    protected LoadDataInformation getDefaultLoadData() {
        ...
        return new LoadDataInformationBuilder()
                ...
                .withResourceLocations(URI.create(
                        "https://raw.githubusercontent.com/instant-solutions/quarkus-moneta-data/refs/heads/main/ecb-historic.xml"))
