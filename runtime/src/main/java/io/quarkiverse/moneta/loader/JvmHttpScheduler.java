...
class JvmHttpScheduler {

    private static final Logger LOG = Logger.getLogger(JvmHttpScheduler.class.getName());

    private final Timer timer;
    private final LoaderListener listener;

    public JvmHttpScheduler(Timer timer, LoaderListener listener) {
        this.timer = timer;
    ...
    public String toString() {
        return JvmHttpScheduler.class.getName() + '{' + " timer: "
                + timer + '}';
    }
}
