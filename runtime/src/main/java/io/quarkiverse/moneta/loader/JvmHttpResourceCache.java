 ...
 * @author Werner Keil
 */
class JvmHttpResourceCache implements ResourceCache {
    /**
     * The logger used.
     */
    private static final Logger LOG = Logger.getLogger(JvmHttpResourceCache.class.getName());
    /**
