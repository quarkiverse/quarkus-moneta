...
public class JvmHttpLoaderService implements LoaderService {
    /**
     * Logger used.
     */
    private static final Logger LOG = Logger.getLogger(JvmHttpLoaderService.class.getName());
    /**
    ...
    private JvmHttpLoaderServiceFacade defaultLoaderServiceFacade;
    ...
    void initialize() {
        ...
        defaultLoaderServiceFacade = new JvmHttpLoaderServiceFacade(timer, listener, resources);
        configurator.load();
    }
    ...
    static ResourceCache getResourceCache() {
        return JvmHttpLoaderService.CACHE;
    }
    ...
    public void registerAndLoadData(String resourceId, UpdatePolicy updatePolicy, Map<String, String> properties,
            Listener listener, URI backupResource, URI... resourceLocations) {
    ...
    @Override
    public void registerData(String resourceId, UpdatePolicy updatePolicy, Map<String, String> properties, Listener listener,
